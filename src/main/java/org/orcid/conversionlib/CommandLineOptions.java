...
public class CommandLineOptions extends OptionsBase {
    ...
    @Option(
            name = "schema-version",
            help = "the schema version of the source file",
            abbrev = 'v',
            defaultValue = "v3_0",
    ...
    @Option(
            name = "input-file",
            help = "Location of the input file (optional, can pipe in)",
            abbrev = 'i',
            defaultValue = ""
    )
    ...
    @Option(
            name = "output-file",
            help = "Location of the output file (optional, can pipe out)",
            abbrev = 'o',
            defaultValue = ""
    )
    ...
    @Option(
            ...
            help = "If true, validate XML input and output against the schema",
            abbrev = 's',
            defaultValue = "false"
    )
    ...
    @Option(
            name = "tarball",
            help = "If true, input is a tar.gz containing XML, output is tar.gz containing JSON",
            abbrev = 't',
            defaultValue = "false"
    )
    ...
    @Option(
            name = "threads",
            help = "Number of worker threads for tarball conversion (0 = number of available processors)",
            abbrev = 'n',
            defaultValue = "0"
    )
    public int threads;
